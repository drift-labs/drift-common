...
const CONSTANTS_DIRECTORY = path.resolve(
	__dirname,
	'../constants/autogenerated'
);

const JUP_V6_CONFIG = {
	filePath: path.join(CONSTANTS_DIRECTORY, 'jup-v6-error-codes.json'),
	programId: 'JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4',
};
const JUP_V4_CONFIG = {
	filePath: path.join(CONSTANTS_DIRECTORY, 'jup-v4-error-codes.json'),
