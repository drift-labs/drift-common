export const DriftErrors = {
	errorsList: {
		...
		InsufficientCollateral: {
			...
			toast: {
				description:
					"You don't have enough collateral, try using less leverage or deposit more collateral.",
			},
		},
		...
		MaxNumberOfPositions: {
			...
			toast: {
				...
				description:
					'Close a position then try again or open it in another subaccount.',
			},
		},
		...
		PriceBandsBreached: {
			...
			toast: {
				...
				description: 'https://docs.drift.trade/protocol-guard-rails#tDZav',
			},
		},
		ExchangePaused: {
			code: 6024,
		...
		ReferrerMustBeWritable: {
			...
			toast: {
				message:
					'Incorrect Write Permission on Referrer Account for Transaction',
				description: '',
			},
		},
		...
		InvalidOracle: {
			...
			msg: 'InvalidOracle',
			toast: {
				message: 'Oracle Information deemed Invalid for Action',
				description: '',
			},
		},
		OracleNotFound: {
		...
		CantDeleteUserWithCollateral: {
			...
			toast: {
				...
				description:
					'User subaccount still has outstanding assets and/or liabilities',
			},
		},
		...
		InvalidOrder: {
			...
			toast: {
				...
				description:
					"Make sure you've configured your order parameters appropriately",
			},
		},
		PlacePostOnlyLimitFailure: {
			...
			toast: {
				...
				description:
					'Must alter maker price or disable post only flag to fill when crossing',
			},
		},
		UserHasNoOrder: {
			code: 6058,
		...
		OrderAmountTooSmall: {
			...
			toast: {
				nessage: 'Order amount too small',
				description: '',
			},
		},
		MaxNumberOfOrders: {
			...
			toast: {
				message:
					'This SubAccount has already has Max Number of Open Orders (32)',
				description:
					'Cancelled orders to place more or create a new subaccount.',
			},
		},
		OrderDoesNotExist: {
			code: 6061,
		...
		UserBankrupt: {
			...
			toast: {
				message: 'Bankrupt',
				description:
					"Couldn't complete action because the user is currently bankrupt",
			},
		},
		UserNotBankrupt: {
			code: 6126,
		...
		DailyWithdrawLimit: {
			...
			toast: {
				...
				description:
					'guard rails around large borrows/withdraws for large accounts are designed to protect the protocol',
			},
		},
		DefaultError: {
			code: 6129,
		...
		MaxOpenInterest: {
			...
			toast: {
				...
				description:
					'This Market has hit max open interest in this direction. You can still reduce positions normally.',
			},
		},
		...
		MarketWithdrawPaused: {
			...
			toast: {
				...
				description:
					'the Market status doesnt allow withdraws. please try again later.',
			},
		},
		...
		InvalidMarketStatusToSettlePnl: {
			...
			toast: {
				...
				description:
					'the Market status doesnt allow pnl settlement. please try again later.',
			},
		},
		...
		InvalidOracleForSettlePnl: {
			...
			toast: {
				...
				description:
					'The Oracle data is too volatile or stale. Please try again in a few minutes.',
			},
		},
		MarginOrdersOpen: {
			code: 6226,
			...
			toast: {
				...
				description:
					'You have orders open that would lead to a borrow being opened.',
			},
		},
