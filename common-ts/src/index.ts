...
import DriftCompetitionsErrors from './constants/autogenerated/driftCompetitionsErrors.json';

export { JupV4Errors, JupV6Errors, DriftCompetitionsErrors };

import PhantomErrors from './constants/phantomErrors';
export { PhantomErrors };
