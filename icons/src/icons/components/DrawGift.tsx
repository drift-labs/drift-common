		...
		<IconWrapper
			icon={
				...
				>
					...
					/>
					<path
						d="M22.222 12.89H9.778a.778.778 0 00-.778.777v1.555c0 .43.348.778.778.778h12.444c.43 0 .778-.348.778-.778v-1.555a.778.778 0 00-.778-.778zM16 12.89V23 12.89z"
						fill={allProps.color ? allProps.color : 'currentColor'}
					/>
					<path
						d="M21.444 16v5.445A1.555 1.555 0 0119.89 23H12.11a1.556 1.556 0 01-1.555-1.555V16M12.5 12.89a1.944 1.944 0 110-3.89c.75-.013 1.486.351 2.11 1.045.624.694 1.109 1.685 1.39 2.844.281-1.16.766-2.15 1.39-2.844.624-.694 1.36-1.058 2.11-1.045a1.944 1.944 0 110 3.89"
						fill={allProps.color ? allProps.color : 'currentColor'}
					/>
					<path
