		...
		<IconWrapper
			icon={
				...
				>
					...
					/>
					<path
						d="M16.588 16.421c2.215-3.562 2.941-7.115 1.622-7.936-1.32-.82-4.185 1.403-6.4 4.965-2.215 3.563-2.941 7.116-1.622 7.936 1.32.82 4.185-1.402 6.4-4.965z"
						fill={allProps.color ? allProps.color : 'currentColor'}
					/>
					<path
						d="M14.296 19.468l3.775 2.347-3.775-2.347zM16.588 16.421l3.823 2.377-3.823-2.377zM18.307 13.018l3.774 2.347-3.774-2.347z"
						fill={allProps.color ? allProps.color : 'currentColor'}
					/>
					<path
						d="M10.188 21.386l3.823 2.377c.633.394 1.664.092 2.864-.839 1.2-.93 2.472-2.415 3.536-4.126 1.063-1.71 1.832-3.508 2.136-4.996.304-1.488.119-2.546-.515-2.94L18.21 8.485"
						fill={allProps.color ? allProps.color : 'currentColor'}
					/>
					<path
